...
const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({ equipment, city }) => {
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-6 right-6 z-40 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg flex items-center justify-center w-16 h-16 transition-all duration-300 hover:scale-110"
